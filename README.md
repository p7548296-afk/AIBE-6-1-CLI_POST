...
- **게시글 검색** : `search?target={대상}&keyword={검색어}&page={번호}`
  - 키워드를 포함한 게시글을 필터링하여 출력합니다. 페이징이 지원됩니다.
  - `target` 옵션: `title`(제목), `content`(내용), `all`(제목+내용 통합, 기본값)
- **도움말** : `help`
...
// Case 1: 제목 검색 성공
명령어: search?target=title&keyword=자바
--- [title] 검색 결과 (키워드: 자바) ---
번호 | 제목          | 조회수 | 등록일
1    | 자바 공부 시작 | 0     | 26-04-15 16:54
--- 현재 페이지: 1 / 1 ---

// Case 2: 통합 검색(제목+내용) 성공
명령어: search?keyword=배워
--- [all] 검색 결과 (키워드: 배워) ---
번호 | 제목          | 조회수 | 등록일
2    | 파이썬 기초    | 0     | 26-04-15 16:55
--- 현재 페이지: 1 / 1 ---
...
번호 | 제목           | 등록일
2    | 파이썬 기초    | 26-04-15 16:55
1    | 자바 공부 시작  | 26-04-15 16:54
--- 현재 페이지: 1 / 1 ---
